  ...
  return (
    <section className="section-padding py-20 lg:py-28 bg-[#16271e] text-white relative overflow-hidden">
      <div className="max-w-5xl mx-auto text-center">
        {/* Eyebrow & Heading with Scroll Reveal */}
        ...
        {/* 2 Wide Event Cards with Directional Scroll Reveals */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          {/* Card 1: Acoustic Nights from Left */}
          <ScrollReveal variant="left" delay={150}>
            <div className="p-8 sm:p-10 rounded-3xl bg-[#f7dcd6] text-[#1c1109] shadow-lg flex flex-col justify-between h-full group hover:shadow-2xl transition-all">
              <div>
                <div className="w-10 h-10 rounded-2xl bg-[#1c1109]/10 flex items-center justify-center text-[#c88242] mb-6 group-hover:scale-110 transition-transform">
          ...
          {/* Card 2: Private Events from Right */}
          <ScrollReveal variant="right" delay={250}>
            <div className="p-8 sm:p-10 rounded-3xl bg-[#f0e6dc] text-[#1c1109] shadow-lg flex flex-col justify-between h-full group hover:shadow-2xl transition-all">
              <div>
                <div className="w-10 h-10 rounded-2xl bg-[#1c1109]/10 flex items-center justify-center text-[#c88242] mb-6 group-hover:scale-110 transition-transform">
