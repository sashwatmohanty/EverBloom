...
import { MapPin, Phone, Clock, Star, Sparkles, Shield, ArrowUpRight, Coffee } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/50">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link to="/admin" className="text-white/40 hover:text-[#e29b5a] transition-colors flex items-center gap-1">
